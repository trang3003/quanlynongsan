...
<body>
    ...
    <div class="humberger__menu__wrapper" style="sticky-top">
        ...
        <div class="humberger__menu__cart">
            <ul>
                <li><a href="./giohang.php"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
            </ul>
        </div>
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="./index.php" method="post">
                                <input type="text" placeholder="Bạn cần tìm gì?" name="ok">
                                <button type="submit" class="site-btn"  name="timkiem" >TÌM KIẾM</button>
                            </form>
                        </div>
                    </div>
                </div>
