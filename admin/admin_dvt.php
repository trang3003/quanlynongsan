...
<html lang="en">
  ...
  <?php
    ...
    if(isset($_GET['search']) && !empty($_GET['search'])){
      $key =$_GET['search'];
      $products=mysqli_query($conn,"SELECT *FROM `donvitinh` WHERE `donvitinh_ten` LIKE '%$key%'");
    }
    else{
      $products=mysqli_query($conn,"SELECT *FROM `donvitinh`");
    }
?>
    <div id="wrapper">
    <?php require './admin_header.php'?>
      <div id="page-wrapper">
        ...
        <a href="./create_dvt.php">Thêm đơn vị tính mới</a>
        <br>
        <br>
        <div class="row">
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i>  Danh sách đơn vị tính</h3>
              </div>
              <div class="panel-body">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    <thead>
                      ...
                      <th>STT <i class="fa fa-sort"></i></th>
                        <th>Tên đơn vị tính <i class="fa fa-sort"></i></th>
                ...
                while($row =mysqli_fetch_array($products)){
                    ...
                    <tr>
                    <td><?=$stt?></td>
                    <td><?=$row['donvitinh_ten']?></td>
                    <td> <?=$row['donvitinh_mota']?></td>
                    <td><a href="./edit_dvt.php?donvitinh_id=<?=$row['donvitinh_id']?>">Sửa</a></td>
                    <td><a href="./delete_dvt.php?donvitinh_id=<?=$row['donvitinh_id']?>">Xóa</a></td>
                    </tr>
                  <?php $stt++; }?>
                    </tbody>
                  </table>
