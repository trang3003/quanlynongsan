...
<html lang="en">
  ...
  <?php
    ...
    if(isset($_GET['search']) && !empty($_GET['search'])){
      $key =$_GET['search'];
      $products=mysqli_query($conn,"SELECT *FROM `loainguoidung` WHERE `loainguoidung_ten` LIKE '%$key%'");
    }
    else{
      $products=mysqli_query($conn,"SELECT *FROM `loainguoidung`");
    }
?>
    <div id="wrapper">
    <?php require './admin_header.php'?>
      <div id="page-wrapper">
        ...
        <a href="./create_lnd.php">Thêm loại người dùng mới</a>
        <br>
        <br>
        <div class="row">
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i>  Danh sách loại người dùng</h3>
              </div>
              <div class="panel-body">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    <thead>
                      ...
                      <th>STT <i class="fa fa-sort"></i></th>
                        <th>Tên loại người dùng <i class="fa fa-sort"></i></th>
                        <th>Sửa</th>
                        <th>Xóa</th>
                      </tr>
                    </thead>
                ...
                while($row =mysqli_fetch_array($products)){
                    ...
                    <td><a href="./edit_lnd.php?loainguoidung_id=<?=$row['loainguoidung_id']?>">Sửa</a></td>
                    <td><a href="./delete_lnd.php?loainguoidung_id=<?=$row['loainguoidung_id']?>">Xóa</a></td>
                    </tr>
                  <?php $stt++; }?>
                    </tbody>
                  </table>
