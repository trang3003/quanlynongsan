...
<?php
    ...
    if(isset($_GET['search']) && !empty($_GET['search'])){
      $key =$_GET['search'];
      $products=mysqli_query($conn,"SELECT *FROM `tinhtrangdh` WHERE `tinhtrang_ten` LIKE '%$key%'");
    }
    else{
      $products=mysqli_query($conn,"SELECT *FROM `tinhtrangdh`");
    }
?>
    <div id="wrapper">
    <?php require './admin_header.php'?>
      <div id="page-wrapper">
        ...
        <a href="./create_tinhtrangdh.php">Thêm tình trạng đơn hàng mới</a>
        <br>
        <br>
        <div class="row">
          <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i>  Danh sách tình trạng đơn hàng</h3>
              </div>
              <div class="panel-body">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    <thead>
                      ...
                      <th>STT <i class="fa fa-sort"></i></th>
                        <th>Tên tình trạng đơn hàng <i class="fa fa-sort"></i></th>
                ...
                while($row =mysqli_fetch_array($products)){
                    ...
                    <td> <?=$row['tinhtrang_mota']?></td>
                    <td><a href="./edit_tinhtrangdh.php?tinhtrang_id=<?=$row['tinhtrang_id']?>">Sửa</a></td>
                    <td><a href="./delete_tinhtrangdh.php?tinhtrang_id=<?=$row['tinhtrang_id']?>">Xóa</a></td>
                    </tr>
                  <?php $stt++; }?>
                    </tbody>
                  </table>
